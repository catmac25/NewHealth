...
const Signup = ()=>{
    ...
    return (
        ...
        <section>
            <br/>
            <div className="flex flex-row justify-center items-center h-160 gap-x-10">
                <div className="flex flex-col justify-center items-center">
                <img src={docimagesign} className="h-80 w-70 shadow-xl"/>
                <br/>
                <p className="font-semibold text-xl text-red-600">Your Health Best-Friend</p>
                </div>
                <form onSubmit={handleSubmit}className="border border-slate-200 rounded-xl bg-white h-130 w-150 shadow-2xl flex flex-col items-center justify-center" >
